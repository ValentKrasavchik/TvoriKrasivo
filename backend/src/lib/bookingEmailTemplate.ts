export type BookingEmailPayload = {
  ...
  /** Цена из каталога мастер-класса (руб.), одна строка в письме */
  priceRub: number;
  slotDate: string;
  slotTime: string;
  name: string;
...
export const BOOKING_CONFIRMATION_SUBJECT = 'Уведомление о записи на мастер-класс';
...
export function buildBookingEmailHtml(p: BookingEmailPayload): string {
...
<head>
  ...
  <title>Запись на мастер-класс</title>
</head>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(44,36,25,0.08);">
          <tr>
            <td bgcolor="#8b6914" style="background-color:#8b6914;background:linear-gradient(135deg,#a67c52 0%,#8b6914 100%);padding:28px 24px;text-align:center;">
              ...
              <p style="margin:8px 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;font-size:13px;color:rgba(255,254,254,0.88);">студия керамики</p>
            </td>
          </tr>
          <tr>
            <td style="padding:28px 24px 8px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
              ...
              <p style="margin:0;font-size:15px;line-height:1.55;color:#5c4d3d;">Спасибо за запись на мастер-класс. Ниже — данные вашей заявки. Мы свяжемся с вами для подтверждения.</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding:0 24px 28px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
              <p style="margin:0;font-size:13px;line-height:1.5;color:#8a7a6a;">Если вы не оставляли эту заявку, просто проигнорируйте письмо.</p>
            </td>
          </tr>
          <tr>
            <td style="background-color:#faf7f4;padding:20px 24px;border-top:1px solid #eee8e0;text-align:center;">
              <p style="margin:0;font-size:13px;color:#6b5344;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">С уважением,<br><strong style="color:#2c2419;">Студия «Твори Красиво»</strong></p>
              <p style="margin:10px 0 0;font-size:12px;color:#9a8b7c;">Донецк · керамика · мастер-классы</p>
            </td>
          </tr>
        </table>
      </td>
